                ...
                Tables\Actions\Action::make('changeStatusAndReply')
                    ...
                    ->extraModalFooterActions([
                        Tables\Actions\Action::make('generateAiReply')
                            ...
                            ->color('warning')
                            ->action(function (array $data, Forms\Components\Component $component) {
                                // هذا الزر سيعمل عبر JavaScript في الواجهة
                            })
                            ->extraAttributes([
                                'x-on:click.prevent' => '
                                    ...
                                    fetch("/ai/generate-reply", {
                                        ...
                                        headers: {
                                            ...
                                            "X-CSRF-TOKEN": document.querySelector("meta[name=csrf-token]")?.content || document.cookie.match(/XSRF-TOKEN=([^;]+)/)?.[1] || "",
